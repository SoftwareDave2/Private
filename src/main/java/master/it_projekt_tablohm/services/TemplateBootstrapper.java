                        ...
                        """
                                 <svg id="root" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 296 128" width="296" height="128">
                                   ...
                                   <g id="state-filled">
                                     ...
                                     <text id="headerTitle" x="8.415" y="29.554" style="fill:#ffffff; font-family: Arial, sans-serif; font-size: 24px">Hinweis</text>
                                     <text id="line1" x="9" y="66" style="fill:#000000; font-family: Arial, sans-serif; font-size: 16px">Zeile 1</text>
                                     <text id="line2" x="9" y="93" style="fill:#000000; font-family: Arial, sans-serif; font-size: 16px">Zeile 2</text>
                                   </g>
                                   ...
                                   <g id="state-idle" style="display:none">
                                     <rect x="0.071" y="0.355" width="296" height="37.374" style="stroke: rgb(255, 0, 0); fill: rgb(255, 0, 0);"/>
                                         ...
                                         <g transform="translate(230, 60) scale(1.5)">
                                             ${QR_CODE_SVG}
                                         </g>

                                         <text style="fill: rgb(51, 51, 51);5 font-family: Arial, sans-serif; white-space: pre; font-size: 16px;" x="20.094" y="60.503">Zum Beschreiben QR-Code scannen</text>
                                    </g>
                                 </svg>
                                """
                ),
