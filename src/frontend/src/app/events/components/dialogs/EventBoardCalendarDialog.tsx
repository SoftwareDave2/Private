    ...
    return (
        ...
        <Dialog open={open} handler={onClose} size={'xl'} className={'max-h-[90vh]'}>
            ...
            <DialogBody className={'space-y-6 overflow-y-auto'}>
                {maxEventsReached && mode !== 'edit' && (
                    <div className={'rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800'}>
                        Maximale Anzahl von vier Ereignissen erreicht. Bearbeiten oder löschen Sie bestehende Einträge, um neue hinzuzufügen.
                    </div>
                )}
